...
<template>
    <div class="min-h-screen bg-zinc-950 p-6 text-zinc-100">
        ...
        >
            ...
            <div class="space-y-1.5">
                ...
                >
                    ...
                    <span class="text-sm text-zinc-400"
                        >Click or drag image here</span
                    >
                    <span class="text-xs text-zinc-600"
                        >PNG, JPG, WEBP up to 2MB</span
                    >
                    <input
                        type="file"
                        accept="image/*"
            ...
            <div
                class="flex items-center gap-3 rounded-lg border border-zinc-700/50 bg-zinc-900 px-4 py-3"
            >
                <button
                    type="button"
            ...
            <div
                class="flex items-center justify-end gap-3 border-t border-zinc-800 pt-6"
            >
                <Link
                    href="/admin/posts"
